...
flat = [number for i in list_of_lists for number in i]
print(flat)
...
list_of_tuples = [(i,) + tuple(i**j for j in range(0, 6)) for i in range(0, 11)]
print(list_of_tuples)

#Change the following list to a list of dictionaries:
countries = [[('Finland', 'Helsinki')], [('Sweden', 'Stockholm')], [('Norway', 'Oslo')]]
alverga = [{"country": count, "city": city} for j in countries for count, city in j]
print(alverga)
